/* ==============================================================================
 * File: fuse.basic.min.js (Third-Party Logic Engine)
 * Author: Amey Thakur (Standardization) / Kiro Risk (Original)
 ...
 *
 * DESCRIPTION:
 * This is a minified distribution of Fuse.js, a lightweight fuzzy-search 
 * library. It serves as the primary computational engine for the site's 
 * archival search functionality, enabling rapid, non-exact document matching.
 *
 * HOW IT WORKS:
 * The script provides the core algorithms for bitap-based fuzzy searching. 
 * It is utilized by 'fastsearch.js' to process the site's JSON search index 
 * client-side, ensuring low-latency retrieval without server-side penalties.
 *
 * TECH STACK:
 * - Fuse.js (Core Engine)
