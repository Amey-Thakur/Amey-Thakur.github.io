...
{{< figure src="figures/Architecture%20of%20NFS.png" caption="Architecture of NFS" align="center" >}}
...
{{< figure src="figures/Features%20of%20NFS.png" caption="Features of NFS" align="center" >}}
...
{{< figure src="figures/Structure%20of%20AFS.png" caption="Structure of AFS - Venus/Vice Components" align="center" >}}
...
{{< figure src="figures/AFS%20-%20Vice%20_%20Venus.png" caption="AFS - Vice & Venus Components" align="center" >}}
...
{{< figure src="figures/Features%20of%20AFS.png" caption="Features of AFS" align="center" >}}
...
{{< figure src="figures/Architecture%20of%20GFS.png" caption="Architecture of GFS" align="center" >}}
...
{{< figure src="figures/Google%20File%20System%20Characteristics.png" caption="Google File System Characteristics" align="center" >}}
...
{{< figure src="figures/Architecture%20of%20HDFS.png" caption="Hadoop Master-Slave Architecture (HDFS + YARN)" align="center" >}}
...
<table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 0.9em;">
    <thead>
        <tr style="border-bottom: 2px solid #ccc;">
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">File System</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">Performance</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">Scalability</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">Availability</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">Fault Tolerance</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">Data Flow</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">Reliability</th>
        </tr>
    </thead>
    <tbody>
        <tr style="border-bottom: 1px solid #eee;">
...
<table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 0.9em;">
    <thead>
        <tr style="border-bottom: 2px solid #ccc;">
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">Feature</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">GFS</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">NFS</th>
            <th style="padding: 10px; text-align: left; background-color: #f8f9fa;">AFS</th>
        </tr>
    </thead>
    <tbody>
        <tr style="border-bottom: 1px solid #eee;">
...
<div style="position: relative; width: 100%; height: 0; padding-bottom: 56.25%; margin-bottom: 20px;">
    <iframe src="PRESENTATION%20-%20A%20COMPARATIVE%20STUDY%20ON%20DISTRIBUTED%20FILE%20SYSTEMS.pdf" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none;" allowfullscreen></iframe>
</div>
...
<div style="display: flex; flex-direction: column; gap: 8px;">
  <div>
    ...
    <a href="PRESENTATION%20-%20A%20COMPARATIVE%20STUDY%20ON%20DISTRIBUTED%20FILE%20SYSTEMS.pdf" target="_blank">Full Presentation (PDF)</a>
  </div>
  <div>
    <!-- Globe/DOI Icon -->
...
<pre style="white-space: pre-wrap;"><code>Thakur, Amey. "A Comparative Study on Distributed File Systems". AmeyArc (Mar 2022). https://amey-thakur.github.io/posts/2022-03-31-distributed-file-systems/.</code></pre>
