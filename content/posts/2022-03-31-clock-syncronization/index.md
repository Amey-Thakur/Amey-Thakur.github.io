...
draft: false
author: "Amey Thakur"
summary: "A comprehensive guide to Clock Synchronization in Distributed Systems, covering algorithms like Cristian's, Berkeley, NTP, Lamport Clocks, Vector Clocks, and Election Algorithms with Python implementations."
tags: ["Distributed Systems", "Clock Synchronization", "Network Time Protocol", "NTP", "Cristian's Algorithm", "Berkeley Algorithm", "Lamport Clocks", "Vector Clocks", "Leader Election", "Bully Algorithm", "Ring Algorithm", "Logical Clocks", "Distributed Algorithms", "Time Synchronization", "Event Ordering", "Causality", "Fault Tolerance", "System Design", "Distributed Computing", "Python"]
ShowToc: true
TocOpen: false
...
{{< figure src="Figures/Figure%201%20-%20Cristian_s%20Algorithm%20Workflow.png" caption="Cristian’s Algorithm Workflow" align="center" >}}
...
{{< figure src="Figures/Figure%202%20-%20Cristian’s%20Algorithm%20Working.png" caption="Cristian’s Algorithm Working" align="center" >}}
...
{{< figure src="Figures/Figure%203%20-%20Berkeley’s%20Algorithm%20Workflow.png" caption="Berkeley’s Algorithm Workflow" align="center" >}}
...
{{< figure src="Figures/Figure%204%20-%20Berkeley’s%20Algorithm%20Working.png" caption="Berkeley’s Algorithm Working" align="center" >}}
...
{{< figure src="Figures/Figure%205%20-%20Architecture%20of%20Network%20Working%20Protocol.png" caption="Architecture of Network Working Protocol" align="center" >}}
...
{{< figure src="Figures/Figure%206%20-%20Working%20of%20Bully%20Algorithm.png" caption="Working of Bully Algorithm" align="center" >}}
...
{{< figure src="Figures/Figure%207%20-%20Working%20of%20Ring%20Algorithm.png" caption="Working of Ring Algorithm" align="center" >}}
...
<div style="position: relative; width: 100%; height: 0; padding-bottom: 56.25%; margin-bottom: 20px;">
    <iframe src="Presentation%20-%20Clock%20Synchronization%20in%20Distributed%20Systems.pdf" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none;" allowfullscreen></iframe>
</div>
...
<div style="display: flex; flex-direction: column; gap: 8px;">
  <div>
    ...
    <a href="https://www.irjet.net/archives/V9/i3/IRJET-V9I3350.pdf" target="_blank">Full Paper (PDF)</a>
  </div>
  <div>
    <!-- Presentation/Slides Icon (Monitor) -->
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle; margin-right: 8px;"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect><line x1="8" y1="21" x2="16" y2="21"></line><line x1="12" y1="17" x2="12" y2="21"></line></svg>
    <a href="Presentation%20-%20Clock%20Synchronization%20in%20Distributed%20Systems.pdf" target="_blank">Presentation (PDF)</a>
  </div>
  <div>
    <!-- GitHub Icon -->
